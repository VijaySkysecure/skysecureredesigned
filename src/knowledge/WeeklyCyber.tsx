          ...
          <div className="weekly-hero-content">
            ...
            <div className="hero-inner">
              ...
              <div className="hero-image">
                <img src="/assets/img/weekly_cyber/weakly_cyber_1.png" alt="Cyber Intelligence Dashboard" />
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container-narrow">
            ...
            <div className="threat-content">
              <div className="threat-landscape-image">
                ...
                <img 
                  src="/assets/img/weekly_cyber/weakly_cyber_2.png" 
          ...
          <div className="container-narrow">
            ...
            <div className="more-grid">
              <div className="more-card">
                <img src="/assets/img/weekly_cyber/weakly_cyber_3.png" alt="Weekly Cyber 3" className="more-image" />
              ...
              <div className="more-card">
                <img src="/assets/img/weekly_cyber/weakly_cyber_4.png" alt="Weekly Cyber 4" className="more-image" />
                <div className="more-content-inner">
              ...
              <div className="more-card">
                <img src="/assets/img/weekly_cyber/weakly_cyber_5.png" alt="Weekly Cyber 5" className="more-image" />
                <div className="more-content-inner">
